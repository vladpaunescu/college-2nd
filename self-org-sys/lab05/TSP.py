...
def computeAttractiveness(eta, tetha, alpha, beta):
    l = len(eta)
    a = []
    for i in range(n):
        a.append(n * [0])
...
#m = nbr of ants
def TSPants(alpha, beta, rho, Q, G, m, NCmax, optimalCost, tetha0 = 0.1):
    l = len(G)
    ...
    a = computeAttractiveness(eta, tetha, alpha, beta)
